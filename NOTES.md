# Notlar — Kullanıcı Profili & Tercihler

## Profil
- Hasan Gündoğdu, öğrenci no 211002086, Düzce BM (İ.Ö.), 2021 DGS girişli.
- 15+ yıldır profesyonel yazılım mühendisi.
- Güçlü: yazılım, CS (OOP, web, veri yapıları, yazılım müh., işletim sistemleri pratiği).
- Zorlanıyor: matematik (Mat, Lineer Cebir, Diferansiyel, Sayısal Analiz, Olasılık), fizik, devre/elektronik. Okuldan uzun süre uzak kaldığı için bu temel dersler pas tutmuş.
...
## Af notu
- Bu yıl af çıkma ihtimali konuşuluyor; kullanıcı **af çıkmayacakmış gibi** çalışmak istiyor.
