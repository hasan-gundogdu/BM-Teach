...
**Durum (2026-07-18):** Tamamlandı — kullanıcı birim çember tanımı, referans açı yöntemi, özel üçgenler (30-60-90, 45-45-90, bonus 15-75) ve vektör bileşen çevirmeyi (Khan Academy pratik sorularıyla) başarıyla uyguladı. `reference/on-bilgi/bolge-cozum-adimlari.html` de eklendi (sade, sadece işlem adımları). Lineer Cebir Ders 03'e (Hafta 4) devam için ek altyapı gerekmiyor.
